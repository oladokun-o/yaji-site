...
<section
	class="relative z-0 -mt-[150px] flex min-h-screen flex-col items-center justify-center gap-10 overflow-x-hidden bg-[#FEE6B4] py-20 md:gap-5 xl:gap-10 pt-30 md:pt-0"
>
	<!-- Section heading -->
